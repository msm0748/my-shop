        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={formik.handleSubmit}>
            ...
            <div>
              ...
              <Link href="/sign-up">
                <a className="group relative flex w-full justify-center rounded-md border border-transparent bg-black py-4 px-4 text-sm font-medium text-white hover:bg-yellow-300 hover:text-black focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 mt-3 transition-colors duration-300">
                  회원가입
                </a>
              </Link>
            </div>
